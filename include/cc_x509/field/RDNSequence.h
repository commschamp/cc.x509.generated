...
/// @file
/// @brief Contains definition of <b>"RDNSequence"</b> field.
...
#include "cc_x509/field/RelativeDistinguishedName.h"
...
struct RDNSequenceMembers
{
    ...
    public:
        ...
        {
            return cc_x509::field::RDNSequenceMembersCommon::TagCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return cc_x509::field::RDNSequenceMembersCommon::TagCommon::name();
        }
    };
    ...
    class Value : public
        comms::field::ArrayList<
            cc_x509::field::FieldBase<>,
            cc_x509::field::RelativeDistinguishedName<TOpt>,
            typename TOpt::cc_x509::field::RDNSequenceMembers::Value,
            comms::option::def::HasName
        >
    {
        using Base =
    ...
    public:
        ...
        static const char* name()
        {
            return cc_x509::field::RDNSequenceMembersCommon::ValueCommon::name();
        }
    };
...
class RDNSequence : public
    comms::field::Bundle<
        cc_x509::field::FieldBase<>,
        typename RDNSequenceMembers<TOpt>::All,
        TExtraOpts...,
        comms::option::def::HasName,
...
public:
    ...
    ///         for cc_x509::field::RDNSequenceMembers::Tag member field.
    ///     @li @b FieldIdx_length index, @b Field_length type and @b field_length() access function -
    ///         for cc_x509::field::RDNSequenceMembers::Length member field.
    ///     @li @b FieldIdx_value index, @b Field_value type and @b field_value() access function -
    ///         for cc_x509::field::RDNSequenceMembers::Value member field.
    ...
    static const char* name()
    {
        return cc_x509::field::RDNSequenceCommon::name();
    }
};
