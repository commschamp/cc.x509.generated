        ...
        struct field
        {
            struct AlgorithmIdentifierMembers
            {
                struct ValueMembers
                {
                    ...
                    ///     field.
                    using Parameters = comms::option::app::EmptyOption;
                }; // struct ValueMembers
            }; // struct AlgorithmIdentifierMembers
        ...
        struct asn1
        {
            ...
            struct der
            {
                ...
                struct field
                {
                    ...
                    {
                        /// @brief Extra options for @ref
                        ///     cc_x509::asn1::der::field::ObjectIdentifierMembers::Value
                        ///     field.
                        using Value = comms::option::app::EmptyOption;
                    }; // struct ObjectIdentifierMembers
            ...
            struct field
            {
                ...
                ///     field.
                using ObjectIdentifierVal = comms::option::app::EmptyOption;
            }; // struct field
        }; // struct asn1
    }; // struct cc_x509
};
