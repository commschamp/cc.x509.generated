...
/// @note Defined in cc_x509/dispatch/DispatchMessage.h
...
auto dispatchMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchMessage<cc_x509::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchMessage<cc_x509::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref cc_x509::options::DefaultOptions.
/// @headerfile cc_x509/dispatch/DispatchMessage.h
...
struct MsgDispatcher
{
    ...
    static auto dispatch(cc_x509::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(cc_x509::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler))
    {
        return cc_x509::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(cc_x509::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(cc_x509::dispatch::dispatchMessage<TProtOptions>(id, msg, handler))
    {
        return cc_x509::dispatch::dispatchMessage<TProtOptions>(id, msg, handler);
    }
...
using MsgDispatcherDefaultOptions =
    MsgDispatcher<cc_x509::options::DefaultOptions>;
