...
#include "cc_x509/input/ClientInputMessages.h"
...
/// @note Defined in cc_x509/dispatch/DispatchClientInputMessage.h
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<cc_x509::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<cc_x509::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref cc_x509::options::DefaultOptions.
/// @headerfile cc_x509/dispatch/DispatchClientInputMessage.h
...
struct ClientInputMsgDispatcher
{
    ...
    static auto dispatch(cc_x509::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(cc_x509::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return cc_x509::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(cc_x509::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(cc_x509::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler))
    {
        return cc_x509::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler);
    }
...
using ClientInputMsgDispatcherDefaultOptions =
    ClientInputMsgDispatcher<cc_x509::options::DefaultOptions>;
