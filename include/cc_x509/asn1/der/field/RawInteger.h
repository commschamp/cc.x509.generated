...
/// @file
/// @brief Contains definition of <b>"RawInteger"</b> field.
...
struct RawIntegerMembers
{
    ...
    public:
        ...
        {
            return cc_x509::asn1::der::field::RawIntegerMembersCommon::TagCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return cc_x509::asn1::der::field::RawIntegerMembersCommon::TagCommon::name();
        }
    };
    ...
    class Value : public
        comms::field::ArrayList<
            cc_x509::field::FieldBase<>,
            std::uint8_t,
            typename TOpt::cc_x509::asn1::der::field::RawIntegerMembers::Value,
            comms::option::def::HasName
        >
    {
        using Base =
    ...
    public:
        ...
        static const char* name()
        {
            return cc_x509::asn1::der::field::RawIntegerMembersCommon::ValueCommon::name();
        }
    };
...
/// @brief Definition of <b>"RawInteger"</b> field.
/// @tparam TOpt Protocol options.
/// @tparam TExtraOpts Extra options.
template <typename TOpt = cc_x509::options::DefaultOptions, typename... TExtraOpts>
class RawInteger : public
    comms::field::Bundle<
        cc_x509::field::FieldBase<>,
        typename RawIntegerMembers<TOpt>::All,
        TExtraOpts...,
        comms::option::def::HasName,
...
public:
    ...
    ///         for cc_x509::asn1::der::field::RawIntegerMembers::Tag member field.
    ///     @li @b FieldIdx_length index, @b Field_length type and @b field_length() access function -
    ///         for cc_x509::asn1::der::field::RawIntegerMembers::Length member field.
    ///     @li @b FieldIdx_value index, @b Field_value type and @b field_value() access function -
    ///         for cc_x509::asn1::der::field::RawIntegerMembers::Value member field.
    ...
    static const char* name()
    {
        return cc_x509::asn1::der::field::RawIntegerCommon::name();
    }
};
